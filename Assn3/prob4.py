...
# @Last modified time: 2018-05-15T18:37:49-07:00
...
def main():
    ...
    plt.title('Validation loss with 2 hidden layers')
    plt.savefig("./Part4-pics/loss.png")

    plt.figure(figsize=(5,3))
    plt.plot(np.arange(1,epochs+1), accv)
    plt.title('Validation accuracy at L2 loss')
    plt.savefig("./Part4-pics/acc.png")
