...
# @Last modified time: 2018-05-15T18:06:00-07:00
...
def main():
    LEARNRATE = 0.1
    WEIGHTDECAY=float(sys.argv[1])
    optimizer = optim.SGD(model.parameters(), lr=LEARNRATE, momentum=0.5, weight_decay=WEIGHTDECAY) #TODO: part 3 , momemntum and weight_decay=0
    epochs = 15
    ...
    plt.title('validation loss at L2 loss = ' + str(WEIGHTDECAY))
    plt.savefig("./Part3-weight-decay-pics/" + str(WEIGHTDECAY) + "WEIGHTDECAYloss.png")

    plt.figure(figsize=(5,3))
    plt.plot(np.arange(1,epochs+1), accv)
    plt.title('validation accuracy at L2 loss = ' + str(WEIGHTDECAY))
    plt.savefig("./Part3-weight-decay-pics/" + str(WEIGHTDECAY) + "WEIGHTDECAYacc.png")
