...
# @Last modified time: 2018-05-15T17:40:31-07:00
...
def main():
    ...
    plt.title('validation loss at dropout = ' + str(DROPOUT))
    plt.savefig("./Part3-drop-out-pics/" + str(DROPOUT) + "DROPOUTloss.png")

    plt.figure(figsize=(5,3))
    plt.plot(np.arange(1,epochs+1), accv)
    plt.title('validation accuracy at dropout = ' + str(DROPOUT))
    plt.savefig("./Part3-drop-out-pics/" + str(DROPOUT) + "DROPOUTacc.png")
