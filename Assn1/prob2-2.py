...
# @Last modified time: 2018-04-16T03:34:17-07:00
import matplotlib
matplotlib.use('Agg')
...
# I wrote this first, but it doesn't work as well for some godforsaken reason - Shing
def train(data, learnRate, epoch, zeros, label, xTest, lTest):
    w = zeros
...
def main():
    ...
    learn = 0.000001
    epoch = 65
    # (coef, accuracy, accuracyTest) = train(x, 0.00005, epoch, w, l, xTest, lTest)
    ...
    # plot(range(epoch), accuracyTest, "acctrain.png")
