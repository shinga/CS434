...
# @Last modified time: 2018-06-13T23:27:10-07:00
import matplotlib
matplotlib.use('Agg')
...
def main():
    ...
    sseTest = sse(sub7test, weightvector)
    # writepredictions(sseTrain,"linear-train.csv")
    writepredictions(sseTest,"individual2_pred3.csv")
    ...
    # print weightvector.shape
    sseTrain = sse(x, weightvector)
    sseTest = sse(sub2test, weightvector)
    # writepredictions(sseTrain,"linear-train.csv")
    writepredictions(sseTest,"individual1_pred3.csv")
